...
mixin _$TodoModel {
  ...
  @JsonKey(fromJson: _completedFromJson)
...
abstract class $TodoModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      String title,
      String content,
      @JsonKey(fromJson: _completedFromJson) bool completed});
}
...
class _$TodoModelImpl extends _TodoModel {
  _$TodoModelImpl(
      ...
      this.title = "",
      this.content = "",
      @JsonKey(fromJson: _completedFromJson) this.completed = false})
      : super._();
  ...
  @override
  String toString() {
    return 'TodoModel(id: $id, title: $title, content: $content, completed: $completed)';
  }
...
abstract class _TodoModel extends TodoModel {
  factory _TodoModel(
          ...
          final String title,
          final String content,
          @JsonKey(fromJson: _completedFromJson) final bool completed}) =
      _$TodoModelImpl;
